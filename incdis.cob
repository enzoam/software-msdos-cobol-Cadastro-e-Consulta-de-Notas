       ...
       PROGRAM-ID INCDIS-COB.
      *           SISTEMAS DE COMPUTACAO
      *    ANALISTA         :ENZO 19 - JAMILE 26
      *    PROGRAMADOR(A)   :ENZO 19 - JAMILE 26
      *    DATA             :
      *    FINALIDADE       :INCLUSAO DE DISCIPLINAS
      *    VRS              DATA              DESCRICAO
      *    1.5              19/09/2000        IMPLANTACAO
      ...
      -            "อออออออออออออออออออออออออออออออออออออออออออออออออผ". 
           ...
           05 line  02   column 31  value 'CADASTRO DE DISCIPLINAS'.
       ...
       0150-resp.
           ...
           IF ws-resp='S' or 's'
              ...
              GO TO 0100-open.
           IF ws-resp='N' or 'n'
              DISPLAY (22 20) 'INCLUSAO DE DISCIPLINAS ABORTADA...'
              STOP RUN.
       ...
       0300-cod-disc.
           ...
           DISPLAY (22 20) linha-branco
           DISPLAY (22 20) 'DISCIPLINA JA CADASTRADA'
           GO TO 0300-cod-disc.


       0400-descricao.
           ACCEPT(10 18) desc-disc with prompt AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (10 18) '      '
       ...
       0500-qtd-aulas.
           ACCEPT(12 19) qtd-aulas with prompt AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (12 19) '   '
