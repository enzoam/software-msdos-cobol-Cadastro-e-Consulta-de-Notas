      ...
      *    1.5              19/09/2000        IMPLANTACAO
      ...
      -            "อออออออออออออออออออออออออออออออออออออออออออออออออผ". 
           ...
           05 line  02   column 31  value 'CADASTRO DE CURSOS'.
       ...
       0150-resp.
           ...
           IF ws-resp='S' or 's'
              ...
              GO TO 0100-open.
           IF ws-resp='N' or 'n'
              DISPLAY (22 20) 'INCLUSAO DE CURSOS ABORTADO...'
              STOP RUN.
       ...
       0210-cod-curso.
           ...
           DISPLAY (22 20) linha-branco
           DISPLAY (22 20) 'CURSO JA CADASTRADO'
           GO TO 0210-cod-curso.

       0300-desc-curso.
           ACCEPT(08 18) descricao with prompt AUTO-SKIP
           DISPLAY (22 20) linha-branco
       ...
       0400-mensalidade.
           ACCEPT(10 20) mensalidade with prompt AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (10 20) '       '
