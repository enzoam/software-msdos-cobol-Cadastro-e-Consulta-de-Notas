       ...
       PROGRAM-ID ALTALU-COB.
      *           SISTEMAS DE COMPUTACAO
      *    ANALISTA         :ENZO 19 - JAMILE 26
      *    PROGRAMADOR(A)   :ENZO 19 - JAMILE 26
      *    DATA             :
      *    FINALIDADE       :ALTERAวรO DE ALUNOS
      *    VRS              DATA              DESCRICAO
      *    1.5              25/08/2000        IMPLANTACAO
      ...
      -            "อออออออออออออออออออออออออออออออออออออออออออออออออผ". 
           ...
           05 line  02   column 31  value 'ALTERACAO DE ALUNOS'.
       ...
       0100-open.
           ...
           DISPLAY (12 30) '[ALUNOS.DAT INEXISTENTE - ABORTADO ]'
           STOP RUN.
       ...
       0300-cod-aluno.
           ...
           ACCEPT(08 21) cod-aluno with update AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ...
           READ alucad INVALID KEY
              DISPLAY (22 20) linha-branco
              DISPLAY (22 20) 'ALUNO NAO CADASTRADA'
              GO TO 0300-cod-aluno. 
           

       0400-nome.
           ACCEPT(10 13) nome with update AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (10 13) '                                   '
       ...
       0500-dia-nasc.
           ACCEPT(12 24) dia-nasc with update AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (12 24) '  '
       ...
       0600-mes-nasc.
           ACCEPT(12 27) mes-nasc  with update AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (12 27) '  '
       ...
       0700-ano-nasc.
           ACCEPT(12 30) ano-nasc with update AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (12 30) '    '
       ...
       0800-rg.
           ACCEPT(12 41) rg with update AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (12 41) '        '
       ...
       0900-endereco.
           ACCEPT(14 17) endereco with update AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (14 17) '                            '
       ...
       1000-cidade.
           ACCEPT(16 15) cidade with update AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (16 15) '               '
       ...
       1100-estado.
           ACCEPT(16 40) estado with update AUTO-SKIP
           DISPLAY (22 20) linha-branco
           ACCEPT ws-retorno FROM ESCAPE KEY
           IF ESC
              DISPLAY (16 40) '  '
