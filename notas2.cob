      ...
      * 1.0      29/03/2000        IMPLATACAO
       ...
       0630-VER-BIM1.
           IF WS-BIM NOT= 1
                DISPLAY (23 25) '1§BIM NAO CADASTRADO P/ O ALUNO'
                GO TO 0615-CODALU.
       ...
       0645-VER-BIM234.
           ...
           IF WS-BIM = 1
              DISPLAY (23 26) '1§ BIM JA CADASTRADO'
              GO TO 0615-CODALU.

           IF WS-BIM = 2  AND BIM-NOTA = 2
              DISPLAY (23 26) '2§ BIM JA CADASTRADO '
              STOP ' '
              GO TO 0615-CODALU.
           ...
           IF WS-BIM = 3
              IF BIM-NOTA = 3
                   DISPLAY (23 26) '3§ BIM JA CADASTRADO '
                   GO TO 0615-CODALU.
              IF BIM-NOTA = 1
                   DISPLAY (23 26) '2§ BIM AINDA NAO CADASTRADO '
                   GO TO 0615-CODALU.
              GO TO 0700-NOTAS-ALU.

           IF WS-BIM = 4
              IF BIM-NOTA = 4 
                   DISPLAY (23 26) '4§ BIM JA CADASTRADO '
                   GO TO 0615-CODALU.
              IF BIM-NOTA = 2
                   DISPLAY (23 26) '3§ BIM AINDA NAO CADASTRADO '
                   GO TO 0615-CODALU.
              IF BIM-NOTA = 1
                   DISPLAY (23 26) '2§ BIM AINDA NAO CADASTRADO '
                   GO TO 0615-CODALU.
